...
func (b *Builder) HasDefinition(id string) bool {
	id = strings.ToLower(id)
	_, ok := b.definitions[id]
	return ok
}

// GetDefinition by its identifier
func (b *Builder) GetDefinition(id string) (def definition.Definition, err error) {
	id = strings.ToLower(id)
